document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateUI(data) {
        ...
        if (sunsetImage && data.img_href) {
            // 直接使用完整的图片URL
            sunsetImage.src = 'https://sunsetbot.top' + data.img_href;
            ...
            if (item.img_href) {
                ...
                historyHtml += `
                    <div class="history-image-container">
                        <img src="${baseUrl}${item.img_href}" alt="${item.city || '未知'}火烧云图" class="history-image" onerror="this.src='placeholder.jpg'; this.alt='图片加载失败';">
